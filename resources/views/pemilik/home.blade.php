        ...
        <div class="col-10 content">
            <div class="col-12 nota labarugi">
                <div class="col-12 kop">
                    <div class="col-12 title-content center">Laporan Penjualan</div>
                    <div class="col-12 tanggal">Per
                        {{ csrf_field() }} 
                        <select class="select-none" id="monthp">
                        ...
                        <select class="select-none" id="yearp">
                ...
                <div class="col-12">
                    <table class="col-11" border="0">
                        <tr><th style="width: 35%"><b>Pendapatan</b></th></tr>
                        <tr>
                            <td>Buku Terjual</td>
                            <td id="buku">{{ $penjualan->jumlah }} Buku</td>
                        </tr>
                        <tr>
                            <td>Pendapatan Penjualan</td>
                            <td  id="penjualan">Rp. {{ number_format($penjualan->total, 0, ',', '.') }},-</td>
                        </tr><tr>
